...
export const NotasPage = () => {
  ...
  // Título y conteo en el Navbar solo en esta vista
  useEffect(() => {
    setPageHeader('Notas', notas.length);
  ...
  return (
    <Layout>
      <div className="w-full h-[calc(100vh-3.5rem)] sm:h-[calc(100vh-4rem)] flex flex-col overflow-hidden">
        {/* Layout 2 columnas - sin header para más espacio */}
          ...
          {fabOpen && (
            <div className="flex flex-col gap-2">
              ...
              <button
                ...
                disabled={isSaving}
                className="flex items-center gap-2 px-4 py-3 bg-black text-white rounded-xl shadow-lg hover:bg-gray-800 font-medium text-sm transition-colors touch-manipulation disabled:opacity-40 disabled:cursor-not-allowed"
              >
                {isSaving ? (
            ...
            <div className="fixed inset-0 z-[210] flex items-center justify-center p-4">
              <div className="bg-white rounded-2xl shadow-xl w-full max-w-md max-h-[85vh] flex flex-col">
                <div className="px-4 py-3 border-b border-gray-100 flex items-center justify-between flex-shrink-0">
                  <h3 className="text-lg font-bold text-gray-800">Notas archivadas</h3>
                  <button
                    type="button"
                ...
                <div className="flex-1 overflow-y-auto p-3 min-h-0">
                  {isLoadingArchivadas ? (
                    ...
                    <div className="p-6 text-sm text-gray-500 text-center">No hay notas archivadas.</div>
                  ) : (
                        ...
                        >
                          ...
                          <div className="flex items-center gap-1">
                            <button
                              ...
                              className="p-2 rounded-lg hover:bg-green-100 text-green-600 disabled:opacity-50 touch-manipulation"
                              title="Recuperar"
                            >
                            ...
                            <button
                              ...
                              className="p-2 rounded-lg hover:bg-red-100 text-red-600 touch-manipulation"
                              title="Eliminar permanentemente"
                            >
                              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
